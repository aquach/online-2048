...
function $s_s_math_Ordering$class__lt__s_math_Ordering__O__O__Z($$this, x, y) {
  var x$1 = $uI(x);
  var y$1 = $uI(y);
  return ($s_s_math_Ordering$IntOrdering$class__compare__s_math_Ordering$IntOrdering__I__I__I($$this, x$1, y$1) < 0)
}
...
function $s_sc_SeqLike$class__updated__sc_SeqLike__I__O__scg_CanBuildFrom__O($$this, index, elem, bf) {
  if ((index < 0)) {
...
function $s_sc_TraversableOnce$class__minBy__sc_TraversableOnce__F1__s_math_Ordering__O($$this, f, cmp) {
  if ($$this.isEmpty__Z()) {
  ...
  $$this.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, minF$1, minElem$1, first$1, f$1, cmp$1) {
    return (function(elem$2) {
      ...
      if (first$1.elem$1) {
        ...
        var y = minF$1.elem$1;
        var jsx$1 = $s_s_math_Ordering$class__lt__s_math_Ordering__O__O__Z(cmp$1, fx, y)
      };
      if (jsx$1) {
...
function $s_scg_GenericTraversableTemplate$class__fail$1__p0__scg_GenericTraversableTemplate__sr_Nothing$($$this) {
...
/** @constructor */
function $c_Lorg_quach_Constants$() {
  $c_O.call(this);
  this.DIRECTIONS$1 = null;
  this.GRID$undSIZE$1 = 0
}
$c_Lorg_quach_Constants$.prototype = new $h_O();
$c_Lorg_quach_Constants$.prototype.constructor = $c_Lorg_quach_Constants$;
/** @constructor */
function $h_Lorg_quach_Constants$() {
  /*<skip>*/
}
$h_Lorg_quach_Constants$.prototype = $c_Lorg_quach_Constants$.prototype;
$c_Lorg_quach_Constants$.prototype.init___ = (function() {
  $n_Lorg_quach_Constants$ = this;
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lorg_quach_DirLeft$(), $m_Lorg_quach_DirRight$(), $m_Lorg_quach_DirDown$(), $m_Lorg_quach_DirUp$()]);
  var this$2 = $m_sci_List$();
  var cbf = this$2.ReusableCBFInstance$2;
  this.DIRECTIONS$1 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf));
  this.GRID$undSIZE$1 = 4;
  return this
});
var $d_Lorg_quach_Constants$ = new $TypeData().initClass({
  Lorg_quach_Constants$: 0
}, false, "org.quach.Constants$", {
  Lorg_quach_Constants$: 1,
  O: 1
});
$c_Lorg_quach_Constants$.prototype.$classData = $d_Lorg_quach_Constants$;
var $n_Lorg_quach_Constants$ = (void 0);
function $m_Lorg_quach_Constants$() {
  if ((!$n_Lorg_quach_Constants$)) {
    $n_Lorg_quach_Constants$ = new $c_Lorg_quach_Constants$().init___()
  };
  return $n_Lorg_quach_Constants$
}
/** @constructor */
function $c_Lorg_quach_Direction() {
  $c_O.call(this)
}
$c_Lorg_quach_Direction.prototype = new $h_O();
$c_Lorg_quach_Direction.prototype.constructor = $c_Lorg_quach_Direction;
/** @constructor */
function $h_Lorg_quach_Direction() {
  /*<skip>*/
}
$h_Lorg_quach_Direction.prototype = $c_Lorg_quach_Direction.prototype;
function $is_Lorg_quach_Direction(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_quach_Direction)))
}
function $as_Lorg_quach_Direction(obj) {
  return (($is_Lorg_quach_Direction(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.quach.Direction"))
}
function $isArrayOf_Lorg_quach_Direction(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_quach_Direction)))
}
function $asArrayOf_Lorg_quach_Direction(obj, depth) {
  return (($isArrayOf_Lorg_quach_Direction(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.quach.Direction;", depth))
}
/** @constructor */
function $c_Lorg_quach_Error() {
  $c_O.call(this)
}
$c_Lorg_quach_Error.prototype = new $h_O();
$c_Lorg_quach_Error.prototype.constructor = $c_Lorg_quach_Error;
/** @constructor */
function $h_Lorg_quach_Error() {
  /*<skip>*/
}
$h_Lorg_quach_Error.prototype = $c_Lorg_quach_Error.prototype;
function $is_Lorg_quach_Error(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_quach_Error)))
}
function $as_Lorg_quach_Error(obj) {
  return (($is_Lorg_quach_Error(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.quach.Error"))
}
function $isArrayOf_Lorg_quach_Error(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_quach_Error)))
}
function $asArrayOf_Lorg_quach_Error(obj, depth) {
  return (($isArrayOf_Lorg_quach_Error(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.quach.Error;", depth))
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_Lorg_quach_LookAheadGreedyHeuristicAI() {
  $c_O.call(this);
  this.lookaheadDepth$1 = 0;
  this.GAME$undOVER$undVALUE$1 = 0;
  this.VICTORY$undVALUE$1 = 0
}
$c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype = new $h_O();
$c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype.constructor = $c_Lorg_quach_LookAheadGreedyHeuristicAI;
/** @constructor */
function $h_Lorg_quach_LookAheadGreedyHeuristicAI() {
  /*<skip>*/
}
$h_Lorg_quach_LookAheadGreedyHeuristicAI.prototype = $c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype;
$c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype.decideMove__Lorg_quach_Grid__Lorg_quach_Direction = (function(g) {
  return this.org$quach$LookAheadGreedyHeuristicAI$$decideMove__Lorg_quach_Grid__I__Lorg_quach_Direction(g, this.lookaheadDepth$1)
});
$c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype.init___I = (function(lookaheadDepth) {
  this.lookaheadDepth$1 = lookaheadDepth;
  this.GAME$undOVER$undVALUE$1 = 214748364;
  this.VICTORY$undVALUE$1 = (-214748364);
  return this
});
$c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype.possibleGridsAfterRandomTwo__Lorg_quach_Grid__sc_Seq = (function(g) {
  var this$2 = g.tiles$1;
  $m_sci_Vector$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  var freeTiles = $as_sci_Vector($as_sc_TraversableLike($as_sc_TraversableLike($s_sc_IterableLike$class__zipWithIndex__sc_IterableLike__scg_CanBuildFrom__O(this$2, bf)).filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$14$2) {
    var x$14 = $as_T2(x$14$2);
    return $as_s_Option(x$14.$$und1__O()).isEmpty__Z()
  })))).map__F1__scg_CanBuildFrom__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$15$2) {
    var x$15 = $as_T2(x$15$2);
    return x$15.$$und2$mcI$sp__I()
  })), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
  $m_sci_Vector$();
  var bf$1 = $m_sc_IndexedSeq$().ReusableCBF$6;
  var b = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(freeTiles, bf$1);
  var this$5 = freeTiles.iterator__sci_VectorIterator();
  while (this$5.$$undhasNext$2) {
    var arg1 = this$5.next__O();
    var tileIndex = $uI(arg1);
    b.$$plus$eq__O__scm_Builder(new $c_Lorg_quach_Grid().init___sci_Vector($as_sci_Vector(g.tiles$1.updated__I__O__scg_CanBuildFrom__O(tileIndex, new $c_s_Some().init___O(2), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)))))
  };
  return $as_sc_Seq($as_sc_TraversableLike(b.result__O()).filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$16$2) {
    var x$16 = $as_Lorg_quach_Grid(x$16$2);
    return (!x$16.isGameOver__Z())
  }))))
});
$c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype.org$quach$LookAheadGreedyHeuristicAI$$decideMove__Lorg_quach_Grid__I__Lorg_quach_Direction = (function(g, maxDepth) {
  var jsx$2 = $m_Lorg_quach_Constants$().DIRECTIONS$1;
  var jsx$1 = new $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1().init___Lorg_quach_LookAheadGreedyHeuristicAI__Lorg_quach_Grid__I(this, g, maxDepth);
  var this$1 = $m_sci_List$();
  var this$2 = $as_sc_TraversableOnce(jsx$2.flatMap__F1__scg_CanBuildFrom__O(jsx$1, this$1.ReusableCBFInstance$2));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$13$2) {
    var x$13 = $as_T2(x$13$2);
    return x$13.$$und2$mcI$sp__I()
  }));
  var cmp = $m_s_math_Ordering$Int$();
  return $as_Lorg_quach_Direction($as_T2($s_sc_TraversableOnce$class__minBy__sc_TraversableOnce__F1__s_math_Ordering__O(this$2, f, cmp)).$$und1__O())
});
/** @constructor */
function $c_Lorg_quach_Online2048$() {
  $c_O.call(this);
  this.ai$1 = null
}
$c_Lorg_quach_Online2048$.prototype = new $h_O();
$c_Lorg_quach_Online2048$.prototype.constructor = $c_Lorg_quach_Online2048$;
/** @constructor */
function $h_Lorg_quach_Online2048$() {
  /*<skip>*/
}
$h_Lorg_quach_Online2048$.prototype = $c_Lorg_quach_Online2048$.prototype;
$c_Lorg_quach_Online2048$.prototype.init___ = (function() {
  $n_Lorg_quach_Online2048$ = this;
  this.ai$1 = new $c_Lorg_quach_HeuristicAI().init___I(2);
  return this
});
$c_Lorg_quach_Online2048$.prototype.getMove__sjs_js_Array__I = (function(jsGrid) {
  var array = [];
  $uI(jsGrid.length);
  var i = 0;
  var len = $uI(jsGrid.length);
  while ((i < len)) {
    var index = i;
    var arg1 = jsGrid[index];
    var this$5 = new $c_sjs_js_ArrayOps().init___sjs_js_Array(arg1);
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$20$2) {
      var x$20 = $uD(x$20$2);
      return $doubleToInt(x$20)
    }));
    var b = new $c_sjs_js_ArrayOps().init___();
    $s_scm_Builder$class__sizeHint__scm_Builder__sc_TraversableLike__V(b, this$5);
    var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, b$1, f$1) {
      return (function(x$2) {
        return b$1.$$plus$eq__O__scm_Builder(f$1.apply__O__O(x$2))
      })
    })(this$5, b, f));
    $s_sc_IndexedSeqOptimized$class__foreach__sc_IndexedSeqOptimized__F1__V(this$5, f$2);
    var array$1 = b.scala$scalajs$js$ArrayOps$$array$f;
    var this$8 = new $c_sjs_js_ArrayOps().init___sjs_js_Array(array$1);
    var f$3 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x0$2$2) {
      var x0$2 = $uI(x0$2$2);
      switch (x0$2) {
        case 0: {
          return $m_s_None$();
        ...
        default: {
          return new $c_s_Some().init___O(x0$2)
        }
      }
    }));
    var b$2 = new $c_sjs_js_ArrayOps().init___();
    $s_scm_Builder$class__sizeHint__scm_Builder__sc_TraversableLike__V(b$2, this$8);
    var f$5 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, b$3, f$4) {
      return (function(x$2$1) {
        return b$3.$$plus$eq__O__scm_Builder(f$4.apply__O__O(x$2$1))
      })
    })(this$8, b$2, f$3));
    $s_sc_IndexedSeqOptimized$class__foreach__sc_IndexedSeqOptimized__F1__V(this$8, f$5);
    var array$2 = b$2.scala$scalajs$js$ArrayOps$$array$f;
    var this$10 = $m_sci_List$();
    var cbf = this$10.ReusableCBFInstance$2;
    var b$4 = cbf.apply__scm_Builder();
    b$4.sizeHint__I__V($uI(array$2.length));
    b$4.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2));
    var elem = $as_sci_List(b$4.result__O());
    array.push(elem);
    i = ((1 + i) | 0)
  };
  var this$12 = $m_sci_List$();
  var cbf$1 = this$12.ReusableCBFInstance$2;
  var b$5 = cbf$1.apply__scm_Builder();
  b$5.sizeHint__I__V($uI(array.length));
  b$5.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var this$13 = $as_sci_List(b$5.result__O());
  $m_sci_List$();
  var b$6 = new $c_scm_ListBuffer().init___();
  var these = this$13;
  while ((!these.isEmpty__Z())) {
    var arg1$1 = these.head__O();
    var xs = $as_sc_GenTraversableOnce(arg1$1).seq__sc_TraversableOnce();
    b$6.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(xs);
    these = $as_sci_List(these.tail__O())
  };
  var this$15 = b$6.toList__sci_List();
  $m_sci_Vector$();
  var cbf$2 = $m_sc_IndexedSeq$().ReusableCBF$6;
  var gridVector = $as_sci_Vector($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$15, cbf$2));
  var grid = new $c_Lorg_quach_Grid().init___sci_Vector(gridVector);
  var move = this.ai$1.decideMove__Lorg_quach_Grid__Lorg_quach_Direction(grid);
  var x = $m_Lorg_quach_DirLeft$();
  if ((x === move)) {
    return 37
  } else {
    var x$3 = $m_Lorg_quach_DirUp$();
    if ((x$3 === move)) {
      return 38
    } else {
      var x$5 = $m_Lorg_quach_DirRight$();
      if ((x$5 === move)) {
        return 39
      } else {
        var x$7 = $m_Lorg_quach_DirDown$();
        if ((x$7 === move)) {
          return 40
        } else {
          throw new $c_s_MatchError().init___O(move)
        }
      }
    }
  }
});
$c_Lorg_quach_Online2048$.prototype.$$js$exported$meth$getMove__sjs_js_Array__O = (function(jsGrid) {
  return this.getMove__sjs_js_Array__I(jsGrid)
});
$c_Lorg_quach_Online2048$.prototype.$$js$exported$meth$main__O = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Hello world!\n")
});
$c_Lorg_quach_Online2048$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
$c_Lorg_quach_Online2048$.prototype.getMove = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$getMove__sjs_js_Array__O(prep0)
});
var $d_Lorg_quach_Online2048$ = new $TypeData().initClass({
  Lorg_quach_Online2048$: 0
}, false, "org.quach.Online2048$", {
  Lorg_quach_Online2048$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lorg_quach_Online2048$.prototype.$classData = $d_Lorg_quach_Online2048$;
var $n_Lorg_quach_Online2048$ = (void 0);
function $m_Lorg_quach_Online2048$() {
  if ((!$n_Lorg_quach_Online2048$)) {
    $n_Lorg_quach_Online2048$ = new $c_Lorg_quach_Online2048$().init___()
  };
  return $n_Lorg_quach_Online2048$
}
$e.org = ($e.org || {});
$e.org.quach = ($e.org.quach || {});
$e.org.quach.Online2048 = $m_Lorg_quach_Online2048$;
/** @constructor */
...
/** @constructor */
function $c_Lorg_quach_HeuristicAI() {
  $c_Lorg_quach_LookAheadGreedyHeuristicAI.call(this)
}
$c_Lorg_quach_HeuristicAI.prototype = new $h_Lorg_quach_LookAheadGreedyHeuristicAI();
$c_Lorg_quach_HeuristicAI.prototype.constructor = $c_Lorg_quach_HeuristicAI;
/** @constructor */
function $h_Lorg_quach_HeuristicAI() {
  /*<skip>*/
}
$h_Lorg_quach_HeuristicAI.prototype = $c_Lorg_quach_HeuristicAI.prototype;
$c_Lorg_quach_HeuristicAI.prototype.init___I = (function(lookaheadDepth) {
  $c_Lorg_quach_LookAheadGreedyHeuristicAI.prototype.init___I.call(this, lookaheadDepth);
  return this
});
$c_Lorg_quach_HeuristicAI.prototype.heuristic__Lorg_quach_Grid__I = (function(g) {
  var end = $m_Lorg_quach_Constants$().GRID$undSIZE$1;
  var isEmpty$4 = (end <= 0);
  if (isEmpty$4) {
    /*<skip>*/
  };
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  var f = new $c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2().init___Lorg_quach_HeuristicAI__Lorg_quach_Grid(this, g);
  $m_sci_IndexedSeq$();
  $m_sc_IndexedSeq$();
  $m_sci_IndexedSeq$();
  $m_sci_Vector$();
  ...
  inlinereturn$23: {
    if ((!isEmpty$4)) {
      ...
      while (true) {
        var arg1 = i;
        var this$7 = f.apply__I__sci_IndexedSeq(arg1);
        $as_sci_VectorBuilder($s_scg_Growable$class__$$plus$plus$eq__scg_Growable__sc_TraversableOnce__scg_Growable(b, this$7));
        if ((i === lastElement$4)) {
  ...
  return $uI($s_sc_TraversableOnce$class__sum__sc_TraversableOnce__s_math_Numeric__O(this$8, num))
});
var $d_Lorg_quach_HeuristicAI = new $TypeData().initClass({
  Lorg_quach_HeuristicAI: 0
}, false, "org.quach.HeuristicAI", {
  Lorg_quach_HeuristicAI: 1,
  Lorg_quach_LookAheadGreedyHeuristicAI: 1,
  O: 1,
  Lorg_quach_AI: 1
});
$c_Lorg_quach_HeuristicAI.prototype.$classData = $d_Lorg_quach_HeuristicAI;
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lorg_quach_Grid() {
  $c_O.call(this);
  this.tiles$1 = null
}
$c_Lorg_quach_Grid.prototype = new $h_O();
$c_Lorg_quach_Grid.prototype.constructor = $c_Lorg_quach_Grid;
/** @constructor */
function $h_Lorg_quach_Grid() {
  /*<skip>*/
}
$h_Lorg_quach_Grid.prototype = $c_Lorg_quach_Grid.prototype;
$c_Lorg_quach_Grid.prototype.isGameOver__Z = (function() {
  var this$1 = $m_Lorg_quach_Constants$().DIRECTIONS$1;
  var these = this$1;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var dir = $as_Lorg_quach_Direction(arg1);
    var x = this.slide__Lorg_quach_Direction__Lorg_quach_Grid(dir);
    if ((!((x !== null) && x.equals__O__Z(this)))) {
      return false
    };
    these = $as_sc_LinearSeqOptimized(these.tail__O())
  };
...
$c_Lorg_quach_Grid.prototype.productPrefix__T = (function() {
  return "Grid"
});
$c_Lorg_quach_Grid.prototype.productArity__I = (function() {
  return 1
});
$c_Lorg_quach_Grid.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lorg_quach_Grid(x$1)) {
    var Grid$1 = $as_Lorg_quach_Grid(x$1);
    var x = this.tiles$1;
    var x$2 = Grid$1.tiles$1;
    return ((x === null) ? (x$2 === null) : $s_sc_GenSeqLike$class__equals__sc_GenSeqLike__O__Z(x, x$2))
  } else {
    return false
  }
});
$c_Lorg_quach_Grid.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.tiles$1;
      break
...
$c_Lorg_quach_Grid.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lorg_quach_Grid.prototype.org$quach$Grid$$collapse__sc_Seq__sc_Seq = (function(vector) {
  var o21 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(vector);
  if ((!o21.isEmpty__Z())) {
    var p3 = $as_s_Option($as_T2(o21.get__O()).$$und1__O());
    var p4 = $as_sc_Seq($as_T2(o21.get__O()).$$und2__O());
    if ($is_s_Some(p3)) {
      var x5 = $as_s_Some(p3);
      var tile1 = $uI(x5.x$2);
      var o20 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(p4);
      if ((!o20.isEmpty__Z())) {
        var p7 = $as_s_Option($as_T2(o20.get__O()).$$und1__O());
        var rest = $as_sc_Seq($as_T2(o20.get__O()).$$und2__O());
        if ($is_s_Some(p7)) {
          var x8 = $as_s_Some(p7);
          var tile2 = $uI(x8.x$2);
          if ((tile1 === tile2)) {
            var x$3 = new $c_s_Some().init___O(((tile1 + tile2) | 0));
            var jsx$1 = this.org$quach$Grid$$collapse__sc_Seq__sc_Seq(rest);
            var this$1 = $m_sc_Seq$();
            return $as_sc_Seq(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(x$3, this$1.ReusableCBFInstance$2))
          }
        }
      }
    }
  };
  var o24 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(vector);
  if ((!o24.isEmpty__Z())) {
    var p10 = $as_s_Option($as_T2(o24.get__O()).$$und1__O());
    var p11 = $as_sc_Seq($as_T2(o24.get__O()).$$und2__O());
    if ($is_s_Some(p10)) {
      var x12 = $as_s_Some(p10);
      var tile1$2 = $uI(x12.x$2);
      var o23 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(p11);
      if ((!o23.isEmpty__Z())) {
        var p14 = $as_s_Option($as_T2(o23.get__O()).$$und1__O());
        var rest$2 = $as_sc_Seq($as_T2(o23.get__O()).$$und2__O());
        if ($is_s_Some(p14)) {
          var x15 = $as_s_Some(p14);
          var tile2$2 = $uI(x15.x$2);
          if ((tile1$2 !== tile2$2)) {
            var x$5 = new $c_s_Some().init___O(tile1$2);
            var x$4 = new $c_s_Some().init___O(tile2$2);
            var this$2 = $m_sc_Seq$();
            var jsx$2 = this.org$quach$Grid$$collapse__sc_Seq__sc_Seq($as_sc_Seq(rest$2.$$plus$colon__O__scg_CanBuildFrom__O(x$4, this$2.ReusableCBFInstance$2)));
            var this$3 = $m_sc_Seq$();
            return $as_sc_Seq(jsx$2.$$plus$colon__O__scg_CanBuildFrom__O(x$5, this$3.ReusableCBFInstance$2))
          }
        }
      }
    }
...
$c_Lorg_quach_Grid.prototype.makeMove__Lorg_quach_Direction__Z__s_util_Either = (function(dir, addTwo) {
  var slidGrid = this.slide__Lorg_quach_Direction__Lorg_quach_Grid(dir);
  if (((slidGrid !== null) && slidGrid.equals__O__Z(this))) {
    $m_s_package$();
    var b = $m_Lorg_quach_NoOp$();
    return new $c_s_util_Right().init___O(b)
  };
  var this$2 = this.tiles$1;
  var this$3 = this$2.iterator__sci_VectorIterator();
  var res = false;
  while (((!res) && this$3.$$undhasNext$2)) {
    var v1 = this$3.next__O();
    var x$11 = $as_s_Option(v1);
    if ((!x$11.isEmpty__Z())) {
      var arg1 = x$11.get__O();
      var x$12 = $uI(arg1);
      res = (x$12 === 2048)
    } else {
      res = false
  ...
  if (res) {
    $m_s_package$();
    var b$1 = $m_Lorg_quach_Victory$();
    return new $c_s_util_Right().init___O(b$1)
  };
  var resultGrid = (addTwo ? slidGrid.withRandomTwo__Lorg_quach_Grid() : slidGrid);
  if (resultGrid.isGameOver__Z()) {
    $m_s_package$();
    var b$2 = $m_Lorg_quach_GameOver$();
    return new $c_s_util_Right().init___O(b$2)
  };
  $m_s_package$();
  return new $c_s_util_Left().init___O(resultGrid)
});
$c_Lorg_quach_Grid.prototype.vectorsToGrid__p1__sc_Seq__Z__Z__sci_Vector = (function(vectors, fromFront, isHorizontal) {
  if (fromFront) {
    var unflipped = vectors
  } else {
    var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$2$2) {
      var x$2 = $as_sc_Seq(x$2$2);
      return $as_sc_Seq(x$2.reverse__O())
    }));
    var this$1 = $m_sc_Seq$();
    var unflipped = $as_sc_Seq(vectors.map__F1__scg_CanBuildFrom__O(jsx$1, this$1.ReusableCBFInstance$2))
  };
  if (isHorizontal) {
    var jsx$2 = unflipped
  } else {
    ...
    inlinereturn$2: {
      if (unflipped.isEmpty__Z()) {
        var jsx$2 = $as_sc_GenTraversable(unflipped.companion__scg_GenericCompanion().newBuilder__scm_Builder().result__O());
        break inlinereturn$2
      };
      var x = unflipped.head__O();
      ...
      var i = 0;
      while ((i < headSize)) {
        var elem = unflipped.companion__scg_GenericCompanion().newBuilder__scm_Builder();
        b.$$plus$eq__O__sci_VectorBuilder(elem);
        i = ((1 + i) | 0)
      };
      var bs = b.result__sci_Vector();
      unflipped.seq__sc_TraversableOnce().foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, headSize$1, bs$1, asTraversable$1) {
        return (function(xs$2) {
          var i$1 = new $c_sr_IntRef().init___I(0);
          $as_sc_GenTraversableOnce(asTraversable$1.apply__O__O(xs$2)).seq__sc_TraversableOnce().foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, headSize$1$1, bs$1$1, i$2) {
            return (function(x$2$1) {
              if ((i$2.elem$1 >= headSize$1$1)) {
                $s_scg_GenericTraversableTemplate$class__fail$1__p0__scg_GenericTraversableTemplate__sr_Nothing$($$this$1)
              };
              $as_scm_Builder(bs$1$1.apply__I__O(i$2.elem$1)).$$plus$eq__O__scm_Builder(x$2$1);
              i$2.elem$1 = ((1 + i$2.elem$1) | 0)
            })
          })($$this, headSize$1, bs$1, i$1)));
          if ((i$1.elem$1 !== headSize$1)) {
            $s_scg_GenericTraversableTemplate$class__fail$1__p0__scg_GenericTraversableTemplate__sr_Nothing$($$this)
          }
        })
      })(unflipped, headSize, bs, asTraversable)));
      var bb = unflipped.companion__scg_GenericCompanion().newBuilder__scm_Builder();
      var this$6 = bs.iterator__sci_VectorIterator();
      while (this$6.$$undhasNext$2) {
        var arg1 = this$6.next__O();
        var b$1 = $as_scm_Builder(arg1);
        bb.$$plus$eq__O__scm_Builder(b$1.result__O())
      };
      var jsx$2 = $as_sc_GenTraversable(bb.result__O())
    }
  };
  return $as_sc_TraversableOnce(jsx$2.flatten__F1__sc_GenTraversable($m_s_Predef$().singleton$und$less$colon$less$2)).toVector__sci_Vector()
});
$c_Lorg_quach_Grid.prototype.gridToVectors__p1__Z__Z__sci_IndexedSeq = (function(fromFront, isHorizontal) {
  var end = $m_Lorg_quach_Constants$().GRID$undSIZE$1;
  var isEmpty$4 = (end <= 0);
  if (isEmpty$4) {
  ...
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  var f = new $c_Lorg_quach_Grid$$anonfun$1().init___Lorg_quach_Grid__Z(this, isHorizontal);
  $m_sci_IndexedSeq$();
  $m_sc_IndexedSeq$();
  $m_sci_IndexedSeq$();
  $m_sci_Vector$();
  ...
  inlinereturn$29: {
    if ((!isEmpty$4)) {
      ...
      while (true) {
        ...
        b.$$plus$eq__O__sci_VectorBuilder(elem);
        if ((i === lastElement$4)) {
          break inlinereturn$29
        };
        i = ((1 + i) | 0)
      }
    }
  };
  var vectors = b.result__sci_Vector();
  if (fromFront) {
    return vectors
  } else {
    $m_sci_IndexedSeq$();
    var bf$1 = $m_sc_IndexedSeq$().ReusableCBF$6;
    var b$1 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(vectors, bf$1);
    var this$8 = vectors.iterator__sci_VectorIterator();
    while (this$8.$$undhasNext$2) {
      var arg1$1 = this$8.next__O();
      var x$1 = $as_sci_IndexedSeq(arg1$1);
      b$1.$$plus$eq__O__scm_Builder($as_sci_IndexedSeq(x$1.reverse__O()))
    };
    return $as_sci_IndexedSeq(b$1.result__O())
  }
});
$c_Lorg_quach_Grid.prototype.slide__Lorg_quach_Direction__Lorg_quach_Grid = (function(dir) {
  var x$2 = $m_Lorg_quach_DirUp$();
  if (((dir !== null) && (dir === x$2))) {
    var shouldTakeFromFront = true
  } else {
    var x$4 = $m_Lorg_quach_DirLeft$();
    var shouldTakeFromFront = ((dir !== null) && (dir === x$4))
  };
  var x$6 = $m_Lorg_quach_DirLeft$();
  if (((dir !== null) && (dir === x$6))) {
    var isHorizontal = true
  } else {
    var x$8 = $m_Lorg_quach_DirRight$();
    var isHorizontal = ((dir !== null) && (dir === x$8))
  };
  var vectors = this.gridToVectors__p1__Z__Z__sci_IndexedSeq(shouldTakeFromFront, isHorizontal);
  var f = new $c_Lorg_quach_Grid$$anonfun$3().init___Lorg_quach_Grid(this);
  $m_sci_IndexedSeq$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  var slidedVectors = $as_sci_IndexedSeq($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(vectors, f, bf));
  var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(v$2) {
      var v = $as_sci_IndexedSeq(v$2);
      var jsx$3 = arg$outer.org$quach$Grid$$collapse__sc_Seq__sc_Seq(v);
      var jsx$2 = $m_Lorg_quach_Constants$().GRID$undSIZE$1;
      var jsx$1 = $m_s_None$();
      var this$2 = $m_sc_Seq$();
      return $as_sc_Seq(jsx$3.padTo__I__O__scg_CanBuildFrom__O(jsx$2, jsx$1, this$2.ReusableCBFInstance$2))
    })
  })(this));
  $m_sci_IndexedSeq$();
  var bf$1 = $m_sc_IndexedSeq$().ReusableCBF$6;
  var collapsedVectors = $as_sci_IndexedSeq($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(slidedVectors, f$1, bf$1));
  return new $c_Lorg_quach_Grid().init___sci_Vector(this.vectorsToGrid__p1__sc_Seq__Z__Z__sci_Vector(collapsedVectors, shouldTakeFromFront, isHorizontal))
});
$c_Lorg_quach_Grid.prototype.getTile__I__I__s_Option = (function(row, col) {
  return $as_s_Option(this.tiles$1.apply__I__O((($imul(row, $m_Lorg_quach_Constants$().GRID$undSIZE$1) + col) | 0)))
});
$c_Lorg_quach_Grid.prototype.init___sci_Vector = (function(tiles) {
  this.tiles$1 = tiles;
  if ((tiles.length__I() !== $imul($m_Lorg_quach_Constants$().GRID$undSIZE$1, $m_Lorg_quach_Constants$().GRID$undSIZE$1))) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(new $c_jl_Exception().init___T(("Bad grid size! Got " + tiles.length__I())))
  };
  return this
});
$c_Lorg_quach_Grid.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lorg_quach_Grid.prototype.withRandomTwo__Lorg_quach_Grid = (function() {
  var this$2 = this.tiles$1;
  $m_sci_Vector$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  var freeTiles = $as_sci_Vector($as_sc_TraversableLike($as_sc_TraversableLike($s_sc_IterableLike$class__zipWithIndex__sc_IterableLike__scg_CanBuildFrom__O(this$2, bf)).filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$9$2) {
    var x$9 = $as_T2(x$9$2);
    return $as_s_Option(x$9.$$und1__O()).isEmpty__Z()
  })))).map__F1__scg_CanBuildFrom__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$10$2) {
    var x$10 = $as_T2(x$10$2);
    return x$10.$$und2$mcI$sp__I()
  })), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
  var jsx$1 = this.tiles$1;
  var this$4 = $m_s_util_Random$();
  var n = freeTiles.length__I();
  return new $c_Lorg_quach_Grid().init___sci_Vector($as_sci_Vector(jsx$1.updated__I__O__scg_CanBuildFrom__O($uI(freeTiles.apply__I__O(this$4.self$1.nextInt__I__I(n))), new $c_s_Some().init___O(2), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6))))
});
$c_Lorg_quach_Grid.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lorg_quach_Grid(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_quach_Grid)))
}
function $as_Lorg_quach_Grid(obj) {
  return (($is_Lorg_quach_Grid(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.quach.Grid"))
}
function $isArrayOf_Lorg_quach_Grid(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_quach_Grid)))
}
function $asArrayOf_Lorg_quach_Grid(obj, depth) {
  return (($isArrayOf_Lorg_quach_Grid(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.quach.Grid;", depth))
}
var $d_Lorg_quach_Grid = new $TypeData().initClass({
  Lorg_quach_Grid: 0
}, false, "org.quach.Grid", {
  Lorg_quach_Grid: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_quach_Grid.prototype.$classData = $d_Lorg_quach_Grid;
/** @constructor */
function $c_Lorg_quach_Grid$$anonfun$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.isHorizontal$1$f = false
}
$c_Lorg_quach_Grid$$anonfun$1.prototype = new $h_sr_AbstractFunction1();
$c_Lorg_quach_Grid$$anonfun$1.prototype.constructor = $c_Lorg_quach_Grid$$anonfun$1;
/** @constructor */
function $h_Lorg_quach_Grid$$anonfun$1() {
  /*<skip>*/
}
$h_Lorg_quach_Grid$$anonfun$1.prototype = $c_Lorg_quach_Grid$$anonfun$1.prototype;
$c_Lorg_quach_Grid$$anonfun$1.prototype.apply__O__O = (function(v1) {
  return this.apply__I__sci_IndexedSeq($uI(v1))
});
$c_Lorg_quach_Grid$$anonfun$1.prototype.init___Lorg_quach_Grid__Z = (function($$outer, isHorizontal$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.isHorizontal$1$f = isHorizontal$1;
  return this
});
$c_Lorg_quach_Grid$$anonfun$1.prototype.apply__I__sci_IndexedSeq = (function(axis1) {
  var end = $m_Lorg_quach_Constants$().GRID$undSIZE$1;
  var isEmpty$4 = (end <= 0);
  if (isEmpty$4) {
    var numRangeElements$4 = 0
  ...
  inlinereturn$29: {
    if ((!isEmpty$4)) {
      ...
      while (true) {
        var arg1 = i;
        var elem = (this.isHorizontal$1$f ? this.$$outer$2.getTile__I__I__s_Option(axis1, arg1) : this.$$outer$2.getTile__I__I__s_Option(arg1, axis1));
        b.$$plus$eq__O__sci_VectorBuilder(elem);
        if ((i === lastElement$4)) {
          break inlinereturn$29
        };
...
var $d_Lorg_quach_Grid$$anonfun$1 = new $TypeData().initClass({
  Lorg_quach_Grid$$anonfun$1: 0
}, false, "org.quach.Grid$$anonfun$1", {
  Lorg_quach_Grid$$anonfun$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lorg_quach_Grid$$anonfun$1.prototype.$classData = $d_Lorg_quach_Grid$$anonfun$1;
/** @constructor */
function $c_Lorg_quach_Grid$$anonfun$3() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lorg_quach_Grid$$anonfun$3.prototype = new $h_sr_AbstractFunction1();
$c_Lorg_quach_Grid$$anonfun$3.prototype.constructor = $c_Lorg_quach_Grid$$anonfun$3;
/** @constructor */
function $h_Lorg_quach_Grid$$anonfun$3() {
  /*<skip>*/
}
$h_Lorg_quach_Grid$$anonfun$3.prototype = $c_Lorg_quach_Grid$$anonfun$3.prototype;
$c_Lorg_quach_Grid$$anonfun$3.prototype.apply__O__O = (function(v1) {
  return this.apply__sci_IndexedSeq__sci_IndexedSeq($as_sci_IndexedSeq(v1))
});
$c_Lorg_quach_Grid$$anonfun$3.prototype.init___Lorg_quach_Grid = (function($$outer) {
  return this
});
$c_Lorg_quach_Grid$$anonfun$3.prototype.apply__sci_IndexedSeq__sci_IndexedSeq = (function(x$6) {
  var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$7$2) {
    var x$7 = $as_s_Option(x$7$2);
    return x$7.isDefined__Z()
  }));
  return $as_sci_IndexedSeq($s_sc_TraversableLike$class__filterImpl__p0__sc_TraversableLike__F1__Z__O(x$6, p, false))
});
var $d_Lorg_quach_Grid$$anonfun$3 = new $TypeData().initClass({
  Lorg_quach_Grid$$anonfun$3: 0
}, false, "org.quach.Grid$$anonfun$3", {
  Lorg_quach_Grid$$anonfun$3: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lorg_quach_Grid$$anonfun$3.prototype.$classData = $d_Lorg_quach_Grid$$anonfun$3;
/** @constructor */
function $c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2() {
  $c_sr_AbstractFunction1.call(this);
  this.g$3$f = null
}
$c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype = new $h_sr_AbstractFunction1();
$c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype.constructor = $c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2;
/** @constructor */
function $h_Lorg_quach_HeuristicAI$$anonfun$heuristic$2() {
  /*<skip>*/
}
$h_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype = $c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype;
$c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype.apply__O__O = (function(v1) {
  return this.apply__I__sci_IndexedSeq($uI(v1))
});
$c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype.init___Lorg_quach_HeuristicAI__Lorg_quach_Grid = (function($$outer, g$3) {
  this.g$3$f = g$3;
  return this
});
$c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype.apply__I__sci_IndexedSeq = (function(row) {
  var end = $m_Lorg_quach_Constants$().GRID$undSIZE$1;
  var isEmpty$4 = (end <= 0);
  if (isEmpty$4) {
    /*<skip>*/
  ...
  inlinereturn$23: {
    if ((!isEmpty$4)) {
      ...
      while (true) {
        var arg1 = i;
        var this$7 = this.g$3$f.getTile__I__I__s_Option(row, arg1);
        if (this$7.isEmpty__Z()) {
          var xo = $m_s_None$()
        } else {
          var arg1$1 = this$7.get__O();
          var value = $uI(arg1$1);
          var multiplier = ((((1 + $imul(2, row)) | 0) + ((1 + $imul(2, arg1)) | 0)) | 0);
          var xo = new $c_s_Some().init___O($imul($imul(((-multiplier) | 0), value), value))
        };
        var this$9 = xo.toList__sci_List();
        $as_sci_VectorBuilder($s_scg_Growable$class__$$plus$plus$eq__scg_Growable__sc_TraversableOnce__scg_Growable(b, this$9));
        if ((i === lastElement$4)) {
          break inlinereturn$23
        };
        i = ((1 + i) | 0)
...
var $d_Lorg_quach_HeuristicAI$$anonfun$heuristic$2 = new $TypeData().initClass({
  Lorg_quach_HeuristicAI$$anonfun$heuristic$2: 0
}, false, "org.quach.HeuristicAI$$anonfun$heuristic$2", {
  Lorg_quach_HeuristicAI$$anonfun$heuristic$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lorg_quach_HeuristicAI$$anonfun$heuristic$2.prototype.$classData = $d_Lorg_quach_HeuristicAI$$anonfun$heuristic$2;
/** @constructor */
function $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.g$1$2 = null;
  this.maxDepth$1$f = 0
}
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype = new $h_sr_AbstractFunction1();
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype.constructor = $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1;
/** @constructor */
function $h_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1() {
  /*<skip>*/
}
$h_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype = $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype;
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lorg_quach_Direction__sc_Iterable($as_Lorg_quach_Direction(v1))
});
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype.init___Lorg_quach_LookAheadGreedyHeuristicAI__Lorg_quach_Grid__I = (function($$outer, g$1, maxDepth$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  ...
  this.g$1$2 = g$1;
  this.maxDepth$1$f = maxDepth$1;
  return this
});
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype.apply__Lorg_quach_Direction__sc_Iterable = (function(d) {
  var afterSlideGrid = this.g$1$2.makeMove__Lorg_quach_Direction__Z__s_util_Either(d, false);
  var rc13 = false;
  var x3 = null;
  matchEnd14: {
    var value;
    if ($is_s_util_Left(afterSlideGrid)) {
      var x2 = $as_s_util_Left(afterSlideGrid);
      var grid = $as_Lorg_quach_Grid(x2.a$2);
      var possibleGrids = this.$$outer$2.possibleGridsAfterRandomTwo__Lorg_quach_Grid__sc_Seq(grid);
      if (possibleGrids.isEmpty__Z()) {
        var jsx$1 = this.$$outer$2.GAME$undOVER$undVALUE$1
      } else {
        var jsx$2 = new $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7().init___Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1(this);
        var this$1 = $m_sc_Seq$();
        var jsx$1 = (($uI($as_sc_TraversableOnce(possibleGrids.map__F1__scg_CanBuildFrom__O(jsx$2, this$1.ReusableCBFInstance$2)).sum__s_math_Numeric__O($m_s_math_Numeric$IntIsIntegral$())) / possibleGrids.size__I()) | 0)
      };
      var value = new $c_s_Some().init___O(jsx$1);
      break matchEnd14
    };
    if ($is_s_util_Right(afterSlideGrid)) {
      rc13 = true;
      x3 = $as_s_util_Right(afterSlideGrid);
      var p4 = $as_Lorg_quach_Error(x3.b$2);
      var x = $m_Lorg_quach_NoOp$();
      if ((x === p4)) {
        var value = $m_s_None$();
        break matchEnd14
      }
    ...
    if (rc13) {
      var p6 = $as_Lorg_quach_Error(x3.b$2);
      var x$3 = $m_Lorg_quach_GameOver$();
      if ((x$3 === p6)) {
        var value = new $c_s_Some().init___O(this.$$outer$2.GAME$undOVER$undVALUE$1);
        break matchEnd14
      }
    };
    if (rc13) {
      var p8 = $as_Lorg_quach_Error(x3.b$2);
      var x$5 = $m_Lorg_quach_Victory$();
      if ((x$5 === p8)) {
        var value = new $c_s_Some().init___O(this.$$outer$2.VICTORY$undVALUE$1);
        break matchEnd14
      }
    };
  ...
  if (value.isEmpty__Z()) {
    ...
    var arg1 = value.get__O();
    var v = $uI(arg1);
    var xo = new $c_s_Some().init___O(new $c_T2().init___O__O(d, v))
  };
  return xo.toList__sci_List()
});
var $d_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1 = new $TypeData().initClass({
  Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1: 0
}, false, "org.quach.LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1", {
  Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1.prototype.$classData = $d_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1;
/** @constructor */
function $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype = new $h_sr_AbstractFunction1();
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype.constructor = $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7;
/** @constructor */
function $h_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7() {
  /*<skip>*/
}
$h_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype = $c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype;
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype.apply__O__O = (function(v1) {
  return this.apply__Lorg_quach_Grid__I($as_Lorg_quach_Grid(v1))
});
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype.apply__Lorg_quach_Grid__I = (function(grid) {
  var finalState = ((this.$$outer$2.maxDepth$1$f === 1) ? ($m_s_package$(), new $c_s_util_Left().init___O(grid)) : grid.makeMove__Lorg_quach_Direction__Z__s_util_Either(this.$$outer$2.$$outer$2.org$quach$LookAheadGreedyHeuristicAI$$decideMove__Lorg_quach_Grid__I__Lorg_quach_Direction(grid, (((-1) + this.$$outer$2.maxDepth$1$f) | 0)), false));
  if ($is_s_util_Left(finalState)) {
    var x2 = $as_s_util_Left(finalState);
    var a = x2.a$2;
    var g = $as_Lorg_quach_Grid(a);
    return this.$$outer$2.$$outer$2.heuristic__Lorg_quach_Grid__I(g)
  } else if ($is_s_util_Right(finalState)) {
    var x3 = $as_s_util_Right(finalState);
    var b = x3.b$2;
    var x0$1 = $as_Lorg_quach_Error(b);
    var x = $m_Lorg_quach_Victory$();
    if ((x === x0$1)) {
      return this.$$outer$2.$$outer$2.VICTORY$undVALUE$1
    } else {
      var x$3 = $m_Lorg_quach_GameOver$();
      if ((x$3 === x0$1)) {
        return this.$$outer$2.$$outer$2.GAME$undOVER$undVALUE$1
      } else {
        throw new $c_s_MatchError().init___O(x0$1)
      }
    }
  } else {
    throw new $c_s_MatchError().init___O(finalState)
  }
});
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype.init___Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7 = new $TypeData().initClass({
  Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7: 0
}, false, "org.quach.LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7", {
  Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7.prototype.$classData = $d_Lorg_quach_LookAheadGreedyHeuristicAI$$anonfun$org$quach$LookAheadGreedyHeuristicAI$$decideMove$1$$anonfun$7;
/** @constructor */
...
/** @constructor */
function $c_Lorg_quach_DirDown$() {
  $c_Lorg_quach_Direction.call(this)
}
$c_Lorg_quach_DirDown$.prototype = new $h_Lorg_quach_Direction();
$c_Lorg_quach_DirDown$.prototype.constructor = $c_Lorg_quach_DirDown$;
/** @constructor */
function $h_Lorg_quach_DirDown$() {
  /*<skip>*/
}
$h_Lorg_quach_DirDown$.prototype = $c_Lorg_quach_DirDown$.prototype;
$c_Lorg_quach_DirDown$.prototype.init___ = (function() {
  return this
});
$c_Lorg_quach_DirDown$.prototype.productPrefix__T = (function() {
  return "DirDown"
});
$c_Lorg_quach_DirDown$.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_quach_DirDown$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_quach_DirDown$.prototype.toString__T = (function() {
  return "DirDown"
});
$c_Lorg_quach_DirDown$.prototype.hashCode__I = (function() {
  return (-960780625)
});
$c_Lorg_quach_DirDown$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lorg_quach_DirDown$ = new $TypeData().initClass({
  Lorg_quach_DirDown$: 0
}, false, "org.quach.DirDown$", {
  Lorg_quach_DirDown$: 1,
  Lorg_quach_Direction: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lorg_quach_DirDown$.prototype.$classData = $d_Lorg_quach_DirDown$;
var $n_Lorg_quach_DirDown$ = (void 0);
function $m_Lorg_quach_DirDown$() {
  if ((!$n_Lorg_quach_DirDown$)) {
    $n_Lorg_quach_DirDown$ = new $c_Lorg_quach_DirDown$().init___()
  };
  return $n_Lorg_quach_DirDown$
}
/** @constructor */
function $c_Lorg_quach_DirLeft$() {
  $c_Lorg_quach_Direction.call(this)
}
$c_Lorg_quach_DirLeft$.prototype = new $h_Lorg_quach_Direction();
$c_Lorg_quach_DirLeft$.prototype.constructor = $c_Lorg_quach_DirLeft$;
/** @constructor */
function $h_Lorg_quach_DirLeft$() {
  /*<skip>*/
}
$h_Lorg_quach_DirLeft$.prototype = $c_Lorg_quach_DirLeft$.prototype;
$c_Lorg_quach_DirLeft$.prototype.init___ = (function() {
  return this
});
$c_Lorg_quach_DirLeft$.prototype.productPrefix__T = (function() {
  return "DirLeft"
});
$c_Lorg_quach_DirLeft$.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_quach_DirLeft$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_quach_DirLeft$.prototype.toString__T = (function() {
  return "DirLeft"
});
$c_Lorg_quach_DirLeft$.prototype.hashCode__I = (function() {
  return (-960552428)
});
$c_Lorg_quach_DirLeft$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lorg_quach_DirLeft$ = new $TypeData().initClass({
  Lorg_quach_DirLeft$: 0
}, false, "org.quach.DirLeft$", {
  Lorg_quach_DirLeft$: 1,
  Lorg_quach_Direction: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_quach_DirLeft$.prototype.$classData = $d_Lorg_quach_DirLeft$;
var $n_Lorg_quach_DirLeft$ = (void 0);
function $m_Lorg_quach_DirLeft$() {
  if ((!$n_Lorg_quach_DirLeft$)) {
    $n_Lorg_quach_DirLeft$ = new $c_Lorg_quach_DirLeft$().init___()
  };
  return $n_Lorg_quach_DirLeft$
}
/** @constructor */
function $c_Lorg_quach_DirRight$() {
  $c_Lorg_quach_Direction.call(this)
}
$c_Lorg_quach_DirRight$.prototype = new $h_Lorg_quach_Direction();
$c_Lorg_quach_DirRight$.prototype.constructor = $c_Lorg_quach_DirRight$;
/** @constructor */
function $h_Lorg_quach_DirRight$() {
  /*<skip>*/
}
$h_Lorg_quach_DirRight$.prototype = $c_Lorg_quach_DirRight$.prototype;
$c_Lorg_quach_DirRight$.prototype.init___ = (function() {
  return this
});
$c_Lorg_quach_DirRight$.prototype.productPrefix__T = (function() {
  return "DirRight"
});
$c_Lorg_quach_DirRight$.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_quach_DirRight$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_quach_DirRight$.prototype.toString__T = (function() {
  return "DirRight"
});
$c_Lorg_quach_DirRight$.prototype.hashCode__I = (function() {
  return 293306799
});
$c_Lorg_quach_DirRight$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lorg_quach_DirRight$ = new $TypeData().initClass({
  Lorg_quach_DirRight$: 0
}, false, "org.quach.DirRight$", {
  Lorg_quach_DirRight$: 1,
  Lorg_quach_Direction: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_quach_DirRight$.prototype.$classData = $d_Lorg_quach_DirRight$;
var $n_Lorg_quach_DirRight$ = (void 0);
function $m_Lorg_quach_DirRight$() {
  if ((!$n_Lorg_quach_DirRight$)) {
    $n_Lorg_quach_DirRight$ = new $c_Lorg_quach_DirRight$().init___()
  };
  return $n_Lorg_quach_DirRight$
}
/** @constructor */
function $c_Lorg_quach_DirUp$() {
  $c_Lorg_quach_Direction.call(this)
}
$c_Lorg_quach_DirUp$.prototype = new $h_Lorg_quach_Direction();
$c_Lorg_quach_DirUp$.prototype.constructor = $c_Lorg_quach_DirUp$;
/** @constructor */
function $h_Lorg_quach_DirUp$() {
  /*<skip>*/
}
$h_Lorg_quach_DirUp$.prototype = $c_Lorg_quach_DirUp$.prototype;
$c_Lorg_quach_DirUp$.prototype.init___ = (function() {
  return this
});
$c_Lorg_quach_DirUp$.prototype.productPrefix__T = (function() {
  return "DirUp"
});
$c_Lorg_quach_DirUp$.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_quach_DirUp$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_quach_DirUp$.prototype.toString__T = (function() {
  return "DirUp"
});
$c_Lorg_quach_DirUp$.prototype.hashCode__I = (function() {
  return 66039784
});
$c_Lorg_quach_DirUp$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lorg_quach_DirUp$ = new $TypeData().initClass({
  Lorg_quach_DirUp$: 0
}, false, "org.quach.DirUp$", {
  Lorg_quach_DirUp$: 1,
  Lorg_quach_Direction: 1,
  O: 1,
  s_Product: 1,
...
$c_Lorg_quach_DirUp$.prototype.$classData = $d_Lorg_quach_DirUp$;
var $n_Lorg_quach_DirUp$ = (void 0);
function $m_Lorg_quach_DirUp$() {
  if ((!$n_Lorg_quach_DirUp$)) {
    $n_Lorg_quach_DirUp$ = new $c_Lorg_quach_DirUp$().init___()
  };
  return $n_Lorg_quach_DirUp$
}
/** @constructor */
function $c_Lorg_quach_GameOver$() {
  $c_Lorg_quach_Error.call(this)
}
$c_Lorg_quach_GameOver$.prototype = new $h_Lorg_quach_Error();
$c_Lorg_quach_GameOver$.prototype.constructor = $c_Lorg_quach_GameOver$;
/** @constructor */
function $h_Lorg_quach_GameOver$() {
  /*<skip>*/
}
$h_Lorg_quach_GameOver$.prototype = $c_Lorg_quach_GameOver$.prototype;
$c_Lorg_quach_GameOver$.prototype.init___ = (function() {
  return this
});
$c_Lorg_quach_GameOver$.prototype.productPrefix__T = (function() {
  return "GameOver"
});
$c_Lorg_quach_GameOver$.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_quach_GameOver$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_quach_GameOver$.prototype.toString__T = (function() {
  return "GameOver"
});
$c_Lorg_quach_GameOver$.prototype.hashCode__I = (function() {
  return (-1704650746)
});
$c_Lorg_quach_GameOver$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lorg_quach_GameOver$ = new $TypeData().initClass({
  Lorg_quach_GameOver$: 0
}, false, "org.quach.GameOver$", {
  Lorg_quach_GameOver$: 1,
  Lorg_quach_Error: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_quach_GameOver$.prototype.$classData = $d_Lorg_quach_GameOver$;
var $n_Lorg_quach_GameOver$ = (void 0);
function $m_Lorg_quach_GameOver$() {
  if ((!$n_Lorg_quach_GameOver$)) {
    $n_Lorg_quach_GameOver$ = new $c_Lorg_quach_GameOver$().init___()
  };
  return $n_Lorg_quach_GameOver$
}
/** @constructor */
function $c_Lorg_quach_NoOp$() {
  $c_Lorg_quach_Error.call(this)
}
$c_Lorg_quach_NoOp$.prototype = new $h_Lorg_quach_Error();
$c_Lorg_quach_NoOp$.prototype.constructor = $c_Lorg_quach_NoOp$;
/** @constructor */
function $h_Lorg_quach_NoOp$() {
  /*<skip>*/
}
$h_Lorg_quach_NoOp$.prototype = $c_Lorg_quach_NoOp$.prototype;
$c_Lorg_quach_NoOp$.prototype.init___ = (function() {
  return this
});
$c_Lorg_quach_NoOp$.prototype.productPrefix__T = (function() {
  return "NoOp"
});
$c_Lorg_quach_NoOp$.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_quach_NoOp$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_quach_NoOp$.prototype.toString__T = (function() {
  return "NoOp"
});
$c_Lorg_quach_NoOp$.prototype.hashCode__I = (function() {
  return 2432930
});
$c_Lorg_quach_NoOp$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lorg_quach_NoOp$ = new $TypeData().initClass({
  Lorg_quach_NoOp$: 0
}, false, "org.quach.NoOp$", {
  Lorg_quach_NoOp$: 1,
  Lorg_quach_Error: 1,
  O: 1,
  s_Product: 1,
...
$c_Lorg_quach_NoOp$.prototype.$classData = $d_Lorg_quach_NoOp$;
var $n_Lorg_quach_NoOp$ = (void 0);
function $m_Lorg_quach_NoOp$() {
  if ((!$n_Lorg_quach_NoOp$)) {
    $n_Lorg_quach_NoOp$ = new $c_Lorg_quach_NoOp$().init___()
  };
  return $n_Lorg_quach_NoOp$
}
/** @constructor */
function $c_Lorg_quach_Victory$() {
  $c_Lorg_quach_Error.call(this)
}
$c_Lorg_quach_Victory$.prototype = new $h_Lorg_quach_Error();
$c_Lorg_quach_Victory$.prototype.constructor = $c_Lorg_quach_Victory$;
/** @constructor */
function $h_Lorg_quach_Victory$() {
  /*<skip>*/
}
$h_Lorg_quach_Victory$.prototype = $c_Lorg_quach_Victory$.prototype;
$c_Lorg_quach_Victory$.prototype.init___ = (function() {
  return this
});
$c_Lorg_quach_Victory$.prototype.productPrefix__T = (function() {
  return "Victory"
});
$c_Lorg_quach_Victory$.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_quach_Victory$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_quach_Victory$.prototype.toString__T = (function() {
  return "Victory"
});
$c_Lorg_quach_Victory$.prototype.hashCode__I = (function() {
  return 2116960754
});
$c_Lorg_quach_Victory$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lorg_quach_Victory$ = new $TypeData().initClass({
  Lorg_quach_Victory$: 0
}, false, "org.quach.Victory$", {
  Lorg_quach_Victory$: 1,
  Lorg_quach_Error: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_quach_Victory$.prototype.$classData = $d_Lorg_quach_Victory$;
var $n_Lorg_quach_Victory$ = (void 0);
function $m_Lorg_quach_Victory$() {
  if ((!$n_Lorg_quach_Victory$)) {
    $n_Lorg_quach_Victory$ = new $c_Lorg_quach_Victory$().init___()
  };
  return $n_Lorg_quach_Victory$
}
/** @constructor */
function $c_T2() {
  $c_O.call(this);
...
$c_sci_Stream$.prototype.filteredTail__sci_Stream__F1__sci_Stream$Cons = (function(stream, p) {
  var hd = stream.head__O();
  var tl = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, stream$1, p$1) {
    return (function() {
      return $as_sci_Stream(stream$1.tail__O()).filter__F1__sci_Stream(p$1)
    })
  })(this, stream, p));
  return new $c_sci_Stream$Cons().init___O__F0(hd, tl)
});
$c_sci_Stream$.prototype.fill__I__F0__sci_Stream = (function(n, elem) {
  if ((n <= 0)) {
    return $m_sci_Stream$Empty$()
  } else {
    var hd = elem.apply__O();
    var tl = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, n$1, elem$1) {
      return (function() {
        return $this.fill__I__F0__sci_Stream((((-1) + n$1) | 0), elem$1)
      })
    })(this, n, elem));
    return new $c_sci_Stream$Cons().init___O__F0(hd, tl)
  }
...
$c_sjs_js_ArrayOps.prototype.filter__F1__O = (function(p) {
  return $s_sc_TraversableLike$class__filterImpl__p0__sc_TraversableLike__F1__Z__O(this, p, false)
});
...
$c_sjs_js_ArrayOps.prototype.drop__I__O = (function(n) {
  var until = $uI(this.scala$scalajs$js$ArrayOps$$array$f.length);
...
$c_sc_AbstractSeq.prototype.$$plus$colon__O__scg_CanBuildFrom__O = (function(elem, bf) {
  return $s_sc_SeqLike$class__$$plus$colon__sc_SeqLike__O__scg_CanBuildFrom__O(this, elem, bf)
});
...
$c_sc_AbstractSeq.prototype.padTo__I__O__scg_CanBuildFrom__O = (function(len, elem, bf) {
  return $s_sc_SeqLike$class__padTo__sc_SeqLike__I__O__scg_CanBuildFrom__O(this, len, elem, bf)
});
/** @constructor */
...
$c_sci_List.prototype.$$plus$colon__O__scg_CanBuildFrom__O = (function(elem, bf) {
  return ($is_scg_GenTraversableFactory$GenericCanBuildFrom(bf) ? new $c_sci_$colon$colon().init___O__sci_List(elem, this) : $s_sc_SeqLike$class__$$plus$colon__sc_SeqLike__O__scg_CanBuildFrom__O(this, elem, bf))
});
...
$c_sci_Stream.prototype.filter__F1__sci_Stream = (function(p) {
  var rest = this;
  while (((!rest.isEmpty__Z()) && (!$uZ(p.apply__O__O(rest.head__O()))))) {
    rest = $as_sci_Stream(rest.tail__O())
  };
  var this$1 = rest;
  if ($s_sc_TraversableOnce$class__nonEmpty__sc_TraversableOnce__Z(this$1)) {
    return $m_sci_Stream$().filteredTail__sci_Stream__F1__sci_Stream$Cons(rest, p)
  } else {
    return $m_sci_Stream$Empty$()
  }
});
$c_sci_Stream.prototype.filter__F1__O = (function(p) {
  return this.filter__F1__sci_Stream(p)
});
$c_sci_Stream.prototype.reverse__O = (function() {
  return this.reverse__sci_Stream()
});
$c_sci_Stream.prototype.loop$3__p4__I__sci_Stream__O__sci_Stream = (function(len, these, elem$2) {
  if (these.isEmpty__Z()) {
    return $m_sci_Stream$().fill__I__F0__sci_Stream(len, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, elem$2$1) {
      return (function() {
        return elem$2$1
      })
    })(this, elem$2)))
  } else {
    var hd = these.head__O();
    var tl = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2, elem$2$2, len$1, these$1) {
      return (function() {
        return this$2.loop$3__p4__I__sci_Stream__O__sci_Stream((((-1) + len$1) | 0), $as_sci_Stream(these$1.tail__O()), elem$2$2)
      })
    })(this, elem$2, len, these));
    return new $c_sci_Stream$Cons().init___O__F0(hd, tl)
  }
});
$c_sci_Stream.prototype.$$plus$colon__O__scg_CanBuildFrom__O = (function(elem, bf) {
  if ($is_sci_Stream$StreamBuilder(bf.apply__O__scm_Builder(this))) {
    ...
    var x = new $c_sci_Stream$Cons().init___O__F0(elem, tl);
    return x
  } else {
    return $s_sc_SeqLike$class__$$plus$colon__sc_SeqLike__O__scg_CanBuildFrom__O(this, elem, bf)
  }
...
$c_sci_Stream.prototype.padTo__I__O__scg_CanBuildFrom__O = (function(len, elem, bf) {
  if ($is_sci_Stream$StreamBuilder(bf.apply__O__scm_Builder(this))) {
    var x = this.loop$3__p4__I__sci_Stream__O__sci_Stream(len, this, elem);
    return x
  } else {
    return $s_sc_SeqLike$class__padTo__sc_SeqLike__I__O__scg_CanBuildFrom__O(this, len, elem, bf)
  }
...
$c_sci_Vector.prototype.updated__I__O__scg_CanBuildFrom__O = (function(index, elem, bf) {
  return ((((bf === ($m_sci_IndexedSeq$(), $m_sc_IndexedSeq$().ReusableCBF$6)) || (bf === $m_sci_Seq$().ReusableCBFInstance$2)) || (bf === $m_sc_Seq$().ReusableCBFInstance$2)) ? this.updateAt__I__O__sci_Vector(index, elem) : $s_sc_SeqLike$class__updated__sc_SeqLike__I__O__scg_CanBuildFrom__O(this, index, elem, bf))
});
